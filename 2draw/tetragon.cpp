...
Circle Tetragon::get_inscribed_circle() {
	...
	if (!(tmp_p1 == p2)) {
		...
		if (distance(p1, p2) + distance(p1, tmp_p2) == distance(tmp_p1, p2) + distance(tmp_p1, tmp_p2)) {
			Triangle tr_p1,tr_p2;
			tr_p1.set(p1, p2, tmp_p2);
			tr_p2.set(tmp_p1, p2, p1);
			double anglep1 = tr_p1.get_angle(1);
			double anglep2 = tr_p2.get_angle(2);
		...
		if (distance(p1, p3) + distance(p1, tmp_p2) == distance(tmp_p1, p3) + distance(tmp_p1, tmp_p2)) {
			Triangle tr_p1, tr_p2;
